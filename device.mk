...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/halium-overlay/etc/default/usb-moded.d/device-specific-config.conf:$(TARGET_COPY_OUT_SYSTEM)/halium/etc/default/usb-moded.d/device-specific-config.conf \
